                ...
                <div className="card md:w-1/2   max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleLogin} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <button className='btn btn-outline btn-xs mt-4' onClick={handleCaptchaValidate}>Validate</button>
                            
                        </div>
                        <div className="form-control mt-6">
                            <input disabled={disabled} className="btn btn-primary" value="Login" />
                        </div>
                    </form>
                </div>
            </div>
